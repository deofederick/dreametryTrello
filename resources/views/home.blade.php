...
<div class="vueapp container" id="paddingtop">
  <div class="row justify-content-center" v-for="allcount in allcounts">
    <div class="col-md-2 placeholder justify-content-center text-center" id="tasktoday">
      ...
      <div class="centered text-white"><h1>@{{ allcount.daily_count }}</h1></div>
      <h4>Today</h4>
    ...
    <div class="col-md-2 placeholder justify-content-center text-center" id="tasktoday">
      ...
      <div class="centered text-white"><h1>@{{ allcount.weekly_count }}</h1></div>
      <h4>This week</h4>
    ...
    <div class="col-md-2 placeholder justify-content-center text-center" id="tasktoday">
      ...
      <div class="centered text-white"><h1>@{{ allcount.monthly_count }}</h1></div>
      <h4>This month</h4>
